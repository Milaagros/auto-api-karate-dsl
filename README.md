...
🖥️ Desde el IDE (IntelliJ, Eclipse)
...
Parte de este proyecto fue construido con el apoyo de ChatGPT
 para acelerar la generación de código y documentación técnica.

🧠 Ejemplo de prompt utilizado:

"Actúa como un experto en automatización de pruebas con Karate DSL y Java. Tengo un endpoint GET /pet/{petId} del contrato https://petstore3.swagger.io/
 y necesito una feature que valide el status 200 y el tipo de datos de la respuesta usando expresiones embebidas."
